    ...
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Agency>().HasData(
                ...
                new Agency { Id = 3, Name = "ESA", Country = "Europe", Description = "European Space Agency.", LogoUrl = "https://upload.wikimedia.org/wikipedia/commons/b/bb/European_Space_Agency_logo.svg" },
                new Agency { Id = 4, Name = "CNSA", Country = "China", Description = "China National Space Administration.", LogoUrl = "https://upload.wikimedia.org/wikipedia/commons/9/98/China_National_Space_Administration_logo.svg" },
            ...
            builder.Entity<Mission>().HasData(
                new Mission { Id = 1, AgencyId = 1, Title = "James Webb Space Telescope", PayloadDescription = "Infrared astronomy mission to explore the early universe.", NewsArticleBody = "The James Webb Space Telescope (JWST) is a space telescope designed primarily to conduct infrared astronomy.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/c/c5/James_Webb_Space_Telescope_2022_rendering.png" },
                new Mission { Id = 2, AgencyId = 1, Title = "Europa Clipper", PayloadDescription = "Studying the Galilean moon Europa to investigate its habitability.", NewsArticleBody = "Europa Clipper will perform dozens of close flybys of Jupiter's moon Europa.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/0/05/Europa_Clipper_spacecraft_model.png" },
                new Mission { Id = 3, AgencyId = 3, Title = "JUICE", PayloadDescription = "Jupiter Icy Moons Explorer studying Ganymede, Callisto, and Europa.", NewsArticleBody = "JUICE will spend at least three years making detailed observations of Jupiter.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/9/9d/JUICE_spacecraft_model.jpg" },
                new Mission { Id = 4, AgencyId = 4, Title = "Chang'e 6", PayloadDescription = "Lunar sample return mission from the far side of the Moon.", NewsArticleBody = "The mission aims to collect samples from the South Pole-Aitken basin.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/2/22/Change_6_lunar_probe.jpg" },
                new Mission { Id = 5, AgencyId = 1, Title = "Artemis II", PayloadDescription = "First crewed mission of the Artemis program to orbit the Moon.", NewsArticleBody = "Artemis II is the first planned crewed mission of NASA's Artemis program.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/c/cb/Artemis_II_mission_patch.png" },
                new Mission { Id = 6, AgencyId = 1, Title = "Artemis III", PayloadDescription = "Human return to the lunar surface.", NewsArticleBody = "Artemis III will be the first human mission to the lunar South Pole.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/4/4c/Artemis_III_mission_patch.png" },
                new Mission { Id = 7, AgencyId = 1, Title = "Lunar Gateway", PayloadDescription = "A lunar space station.", NewsArticleBody = "Gateway will serve as a multi-purpose outpost orbiting the Moon.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/6/69/Gateway_in_lunar_orbit_%28artist%27s_concept%29.jpg" },
                new Mission { Id = 8, AgencyId = 1, Title = "Mars Sample Return", PayloadDescription = "Bringing Mars rocks to Earth.", NewsArticleBody = "MSR will collect and return Martian samples for the first time.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/e/e0/Mars_Sample_Return_mission_concept.png" },
                new Mission { Id = 9, AgencyId = 1, Title = "Dragonfly", PayloadDescription = "Rotorcraft to explore Titan.", NewsArticleBody = "Dragonfly will explore the chemistry of Saturn's moon Titan.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/8/87/Dragonfly_on_Titan_%28artist%27s_concept%29.jpg" },
                new Mission { Id = 10, AgencyId = 3, Title = "LISA", PayloadDescription = "Gravitational wave observatory.", NewsArticleBody = "LISA will detect gravitational waves from space.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/5/52/LISA_artist_impression.jpg" }
            );
